...
from supabase.client import Client, create_client,supabase
...
matched_docs = vector_store.similarity_search(query, 0.5)
code_string = ""

for doc in matched_docs:
    code_string += doc.page_content + "\n\n"
    print("\n\033[35m" + code_string + "\n\033[32m")
...
chain.run(code=code_string, query=query)
